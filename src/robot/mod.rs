...
const DOT_GITIGNORE: &[u8] = include_bytes!("../../templates/robot/.gitignore");
const ROBOTMK_ENV: &[u8] = include_bytes!("../../templates/robot/robotmk-env.yaml");
const ROBOTMK_SETUP: &[u8] = include_bytes!("../../templates/robot/robotmk-setup.yaml");
const ROBOT_TOML: &[u8] = include_bytes!("../../templates/robot/robot.toml");
const DOT_ROBOT_TOML: &[u8] = include_bytes!("../../templates/robot/.robot.toml");
const SAMPLE_ROBOT: &[u8] = include_bytes!("../../templates/robot/sample.robot");
